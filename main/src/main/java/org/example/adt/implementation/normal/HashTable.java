...
public class HashTable {
    ...
    /*
    Devuelve un numero calculado de un objeto que se le haya ingresado a partir de una formula que desconocemos
    y sacamos su modulo con la capacidad para mantenerla dentro de los limites de la "lista"
     */
